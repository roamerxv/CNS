!function (t) {
    ...
    function a(e, n, i) {
        ...
        l(e), e.each(function (n, i) {
            var l = n === e.length - 1 ? s : r, d = t(i).outerHeight(!0);
            ...
            var i = e === o.length - 1 ? s : r, l = a[e], c = i - (l - u[e]);
            l < i && t(n).height(c)
        })
    }
    ...
    function f(t, e) {
        var n = t.offset(), i = g(t), r = n.left + y(t, "border-left-width") + i.left - (e ? e.left : 0),
    ...
    function m() {
        var e = t("<div><div/></div>").css({
            ...
            overflow: "scroll",
            direction: "rtl"
        }).appendTo("body"), n = e.children().offset().left > e.offset().left;
        return e.remove(), n
    }
    ...
    function yt(e, n) {
        ...
        function r(i) {
            var r = e.theme, s = t('<div class="fc-' + i + '"/>'), o = n.layout[i], l = e.opt("customButtons") || {},
                u = e.overrides.buttonText || {}, c = e.opt("buttonText") || {};
    ...
    function At(t) {
        var e, n, i, r, s;
        for (e = 0; e < t.length; e++) for (n = t[e], i = 0; i < n.length; i++) for ((r = n[i]).forwardSegs = [], s = e + 1; s < t.length; s++) Lt(r, t[s], r.forwardSegs)
    }
    ...
    var Vt = t.fullCalendar = {version: "3.6.2", internalApiVersion: 11}, Gt = Vt.views = {};
    ...
    Vt.preventDefault = R, Vt.intersectRects = T, Vt.parseFieldSpecs = x, Vt.compareByFieldSpecs = P, Vt.compareByFieldSpec = z, Vt.flexibleCompare = F, Vt.computeGreatestUnit = L, Vt.divideRangeByDuration = function (t, e, n) {
        ...
        var i;
        return G(t) ? e.duration(t * n) : (i = t.asMonths(), Math.abs(i) >= 1 && rt(i) ? e.duration({months: i * n}) : e.duration({days: t.asDays() * n}))
    ...
    Xt.push("_fullCalendar"), Xt.push("_ambigTime"), Xt.push("_ambigZone"), Vt.moment = function () {
        ...
        function e(t, e, n, i, r) {
            var s, o, a, l = t.sameUnits, d = e.clone().stripZone(), h = n.clone().stripZone(),
                f = u(t.fakeFormatString, e), g = u(t.fakeFormatString, n), p = "", v = "", m = "", y = "", w = "";
        ...
        function i(t) {
            var e = r(t);
            return {fakeFormatString: o(e), sameUnits: a(e)}
        }

        function r(t) {
            for (var e, n = [], i = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; e = i.exec(t);) e[1] ? n.push.apply(n, s(e[1])) : e[2] ? n.push({maybe: r(e[2])}) : e[3] ? n.push({token: e[3]}) : e[5] && n.push.apply(n, s(e[5]));
            return n
        }
        ...
        var d = "\v", h = "", f = "", g = new RegExp(f + "([^" + f + "]*)" + f, "g"), p = {
            t: function (e) {
    ...
    var ee = Vt.EmitterMixin = {
        ...
        _props: null, _watchers: null, _globalWatchArgs: {}, constructor: function () {
            ...
            var o = this, a = 0, l = t.length, u = 0, c = {}, d = [], h = !1;
    ...
    var ue = ut.extend(ne, {
        ...
        handleMove: function (t) {
            var e = D(t) - this.originX, n = b(t) - this.originY, i = this.minDistance;
    ...
    var ve = ut.extend({
        ...
        dragListener: null, constructor: function (t) {
            ...
            var t, e = this, n = this.component, i = new he(n, {
        ...
        buildDragListener: function (t) {
            var e, n, i, r = this, a = this.component, l = this.view, u = l.calendar, c = u.eventManager, d = t.el,
        ...
        buildDragListener: function (t, e) {
            var n, i, r = this, a = this.component, l = this.view, u = l.calendar, c = u.eventManager, d = t.el,
                h = t.footprint.eventDef, f = t.footprint.eventInstance;
            return this.dragListener = new he(a, {
                ...
                hitOver: function (n, o, d) {
                    var f, g = !0, p = a.getSafeHitFootprint(d), v = a.getSafeHitFootprint(n);
        ...
        dragListener: null, isDragging: !1, end: function () {
            ...
            var i, r = this, a = this.component, l = this.view, u = vt(t);
            ...
            var i, r = this.view.calendar, s = Vt.moment.utc(e.unzonedRange.startMs).stripZone();
    ...
    var Ee = Vt.EventPointing = ve.extend({
        ...
        buildSegHtml: function (t, e, n) {
            var i = n.getClasses ? n.getClasses(e) : [], r = tt(n.getCss ? n.getCss(e) : {});
        ...
        fabricateEventFootprint: function (t) {
            var e, n = this.view.calendar, i = n.footprintToDateProfile(t), r = new je(new en(n));
    ...
    var xe = Vt.InteractiveDateComponent = Me.extend({
        ...
        sliceRangeByDay: function (t) {
            var e, n, i, r, s, o, a = this.daysPerRow, l = this.view.computeDayRange(t),
                u = this.getDateDayIndex(l.start), c = this.getDateDayIndex(l.end.clone().subtract(1, "days")), d = [];
            for (e = 0; e < this.rowCnt; e++) for (i = (n = e * a) + a - 1, r = n; r <= i; r++) s = Math.max(u, r), o = Math.min(c, r), (s = Math.ceil(s)) <= (o = Math.floor(o)) && d.push({
                row: e,
        ...
        renderHeadDateCellHtml: function (t, e, n) {
            var i = this.view, r = this.dateProfile.activeUnzonedRange.containsDate(t),
                s = ["fc-day-header", i.calendar.theme.getClass("widgetHeader")], o = K(t.format(this.colHeadFormat));
        ...
        initRenderQueue: function () {
            this.renderQueue = new le({event: this.opt("eventRenderWait")}), this.renderQueue.on("start", this.onRenderQueueStart.bind(this)), this.renderQueue.on("stop", this.onRenderQueueStop.bind(this)), this.on("before:change", this.startBatchRender), this.on("change", this.stopBatchRender)
        },
        ...
        executeDateRender: function (t) {
            Me.prototype.executeDateRender.apply(this, arguments), this.render && this.render(), this.trigger("datesRendered"), this.addScroll({isDateInit: !0}), this.startNowIndicator()
        },
        executeDateUnrender: function () {
        ...
        reportEventDrop: function (t, n, i, r) {
            var s = this.calendar.eventManager.mutateEventsWithId(t.def.id, n, this.calendar), o = n.dateMutation;
    ...
    ze.watch("displayingDates", ["isInDom", "dateProfile"], function (t) {
        ...
        buildDateProfile: function (t, n, i) {
            var r, s, o, a, l, u, c = !t.hasTime(), d = null, h = null;
    ...
    var Fe = Vt.Calendar = ut.extend(ee, ne, {
        ...
        initEventManager: function () {
            var t = this, e = new Ge(this), n = this.opt("eventSources") || [], i = this.opt("events");
    ...
    Fe.mixin({
        ...
        viewSpecCache: null, getViewSpec: function (t) {
            ...
            for (var i, r, s, o, a, l = this.overrides.views || {}, u = [], c = [], d = [], h = t; h;) i = Gt[h], r = l[h], h = null, "function" == typeof i && (i = {class: i}), i && (u.unshift(i), c.unshift(i.defaults || {}), s = s || i.duration, h = h || i.type), r && (d.unshift(r), s = s || r.duration, h = h || r.type);
        ...
        initialRender: function () {
            ...
            n.addClass("fc"), n.on("click.fc", "a[data-goto]", function (n) {
                var i = t(this).data("goto"), r = e.moment(i.date), s = i.type,
                ...
                var i = new (an.getThemeClass(t.themeSystem || t.theme))(e.optionsModel), r = i.getClass("widget");
        ...
        var e, n = t.getEventDef(), i = this.eventRangesToEventFootprints(t.getAllEventRanges()),
            r = this.getPeerEventInstances(n).map(Ht), s = this.eventRangesToEventFootprints(r), o = n.getConstraint(),
            a = n.getOverlap(), l = this.opt("eventAllow");
        for (e = 0; e < i.length; e++) if (!this.isFootprintAllowed(i[e].componentFootprint, s, o, a, i[e].eventInstance)) return !1;
        if (l) for (e = 0; e < i.length; e++) if (!1 === l(i[e].componentFootprint.toLegacy(this), i[e].getEventLegacy())) return !1;
        return !0
        ...
        var e, n = this.eventManager.getEventInstances().map(Ht), i = this.eventRangesToEventFootprints(n);
        ...
        var e = this.eventManager, n = We.parse(t, new en(this));
        ...
        getEventSources: function () {
            ...
            var n = this.eventManager, i = We.parse(t, t.source || n.stickySource);
            i && n.addEventDef(i, e)
        }, removeEvents: function (t) {
            var e, n = this.eventManager, i = [], r = {};
            if (null == t) n.removeAllEventDefs(!0); else {
        ...
        longPressDelay: 1e3
    }, Fe.englishDefaults = {dayPopoverFormat: "dddd, MMMM D"}, Fe.rtlDefaults = {
        header: {
    ...
    var Ue = {start: "09:00", end: "17:00", dow: [1, 2, 3, 4, 5], rendering: "inverse-background"},
    ...
    var je = qe.extend({
        dateProfile: null, buildInstances: function () {
            ...
            var e = qe.prototype.applyManualStandardProps.apply(this, arguments), n = $e.parse(t, this.source);
            return !!n && (this.dateProfile = n, null != t.date && (this.miscProps.date = t.date), e)
        }
    });
    je.defineStandardProps({start: !1, date: !1, end: !1, allDay: !1});
    var Ye = qe.extend({
    ...
    Ye.defineStandardProps({start: !1, end: !1, dow: !1});
    var Ze = ut.extend({
        ...
        sliceInverseRenderRanges: function (t) {
            var e = this.eventInstances.map(xt), n = this.getEventDef();
    ...
    Je.createFromRawProps = function (t, e, n) {
        var i, r, s, o, a = t.def, l = {}, u = {}, c = {}, d = {}, h = null, f = null;
    ...
    tn.createFromDiff = function (t, e, n) {
        ...
        var r, s, o, a = t.end && !e.end, l = t.isAllDay() && !e.isAllDay(), u = !t.isAllDay() && e.isAllDay();
    ...
    var rn = en.extend({
        rawEventDefs: null, eventDefs: null, currentTimezone: null, constructor: function (t) {
            ...
            if (null !== this.currentTimezone && this.currentTimezone !== n) for (i = 0; i < r.length; i++) r[i] instanceof je && r[i].rezone();
    ...
    rn.defineStandardProps({events: !1}), rn.parse = function (e, n) {
        var i;
        return t.isArray(e.events) ? i = e : t.isArray(e) && (i = {events: e}), !!i && en.parse.call(this, i, n)
    ...
    sn.defineStandardProps({events: !1}), sn.parse = function (e, n) {
        var i;
        return t.isFunction(e.events) ? i = e : t.isFunction(e) && (i = {events: e}), !!i && en.parse.call(this, i, n)
    ...
    on.AJAX_DEFAULTS = {dataType: "json", cache: !1}, on.defineStandardProps({
        url: !0,
        startParam: !0,
        endParam: !0,
        timezoneParam: !0
        ...
        var n;
        return "string" == typeof t.url ? n = t : "string" == typeof t && (n = {url: t}), !!n && en.parse.call(this, n, e)
    ...
    var hn = Te.extend({
        ...
        dayGrid: null, rowStructs: null, constructor: function (t) {
            ...
            var r, s, o, a, l, u, c, d = this.dayGrid.colCnt, h = this.buildSegLevels(n), f = Math.max(1, h.length),
                g = t("<tbody/>"), p = [], v = [], m = [];
            for (r = 0; r < f; r++) {
    ...
    pn.mixin({
        segPopover: null, popoverSegs: null, removeSegPopover: function () {
            ...
            var n, i, r, s = this.rowEls.eq(e).height(), o = this.eventRenderer.rowStructs[e].tbodyEl.children();
            for (n = 0; n < o.length; n++) if (i = o.eq(n).removeClass("fc-limited"), r = 0, i.find("> td > :first-child").each(function (e, n) {
            ...
            var r, s, o, a, l, u, c, d, h, f, g, p, v, m, y, w = this, D = this.eventRenderer.rowStructs[e], b = [],
                E = 0;
            ...
            return t('<a class="fc-more"/>').text(this.getMoreLinkText(i.length)).on("click", function (o) {
                var a = r.opt("eventLimitClick"), l = r.getCellDate(e, n), u = t(this), c = r.getCellEl(e, n),
                    d = r.getCellSegs(e, n), h = r.resliceDaySegs(d, l), f = r.resliceDaySegs(i, l);
                "function" == typeof a && (a = r.publiclyTrigger("eventLimitClick", {
                    context: s,
                    args: [{date: l.clone(), dayEl: c, moreEl: u, segs: h, hiddenSegs: f}, o, s]
            ...
            var r, s = this.view.calendar.theme, o = this.getCellDate(e, n).format(this.opt("dayPopoverFormat")),
            ...
            var i, r, s, o = n.clone(), a = o.clone().add(1, "days"), l = new Oe(o, a), u = [];
    ...
    var vn = Vt.BasicView = ze.extend({
        ...
        buildRenderRange: function (t, e, n) {
            var i = ze.prototype.buildRenderRange.apply(this, arguments), r = this.calendar.msToUtcMoment(i.startMs, n),
    ...
    Gt.basic = {class: vn}, Gt.basicDay = {type: "basic", duration: {days: 1}}, Gt.basicWeek = {
        type: "basic",
        duration: {weeks: 1}
    }, Gt.month = {class: yn, duration: {months: 1}, defaults: {fixedWeekCount: !0}};
    var wn = Te.extend({
        attachSegEls: function (t, e) {
        ...
        timeGrid: null, constructor: function (t) {
            ...
            var n, i, r, s = this.view, o = s.calendar, a = t.footprint.componentFootprint, l = a.isAllDay,
                ...
                h = !e && t.isEnd && s.isEventDefResizableFromEnd(u), f = this.getSegClasses(t, c, d || h),
        ...
        computeLabelInterval: function (t) {
            var n, i, r;
            for (n = In.length - 1; n >= 0; n--) if (i = e.duration(In[n]), r = V(i, t), rt(r) && r > 1) return i;
            return e.duration(t)
        },
        renderDates: function (t) {
    ...
    }, Tn = 5, In = [{hours: 1}, {minutes: 30}, {minutes: 15}, {seconds: 30}, {seconds: 15}];
    Gt.agenda = {
        class: Sn,
        defaults: {allDaySlot: !0, slotDuration: "00:30:00", slotEventOverlap: !0}
    }, Gt.agendaDay = {type: "agenda", duration: {days: 1}}, Gt.agendaWeek = {type: "agenda", duration: {weeks: 1}};
    var Hn = Vt.ListView = ze.extend({
        ...
        dayRanges: null,
        constructor: function () {
            ze.apply(this, arguments), this.scroller = new pe({overflowX: "hidden", overflowY: "auto"})
        },
        renderSkeleton: function () {
        ...
        dayHeaderHtml: function (t) {
            ...
            return '<tr class="fc-list-heading" data-date="' + t.format("YYYY-MM-DD") + '"><td class="' + this.calendar.theme.getClass("widgetHeader") + '" colspan="3">' + (e ? this.buildGotoAnchorHtml(t, {class: "fc-list-heading-main"}, K(t.format(e))) : "") + (n ? this.buildGotoAnchorHtml(t, {class: "fc-list-heading-alt"}, K(t.format(n))) : "") + "</td></tr>"
        }
    });
    return Gt.list = {
        class: Hn,
    ...
    }, Gt.listDay = {type: "list", duration: {days: 1}, defaults: {listDayFormat: "dddd"}}, Gt.listWeek = {
        type: "list",
        duration: {weeks: 1},
    ...
    }, Gt.listYear = {type: "list", duration: {year: 1}, defaults: {listDayAltFormat: "dddd"}}, Vt
}), function (t) {
    ...
    var i = t.fullCalendar, r = i.Promise, s = i.EventSource, o = i.JsonFeedEventSource, a = i.EventSourceParser,
        l = i.applyAll, u = s.extend({
            ...
            fetch: function (e, n, i) {
                var s = this, a = this.buildUrl(), u = this.buildRequestParams(e, n, i), c = this.ajaxSettings,
                    d = c.success;
                return u ? (this.calendar.pushLoading(), r.construct(function (e, n) {
                    t.ajax(t.extend({}, o.AJAX_DEFAULTS, c, {
                        url: a, data: u, success: function (i) {
                            var r, o;
            ...
            reportError: function (t, e) {
                var n = this.calendar, r = n.opt("googleCalendarError"), s = e || [{message: t}];
            ...
            applyManualStandardProps: function (t) {
                var n = s.prototype.applyManualStandardProps.apply(this, arguments), i = t.googleCalendarId;
    ...
    u.API_BASE = "https://www.googleapis.com/calendar/v3/calendars", u.defineStandardProps({
        ...
        var n;
        return "object" == typeof t ? n = t : "string" == typeof t && (n = {url: t}), !!n && s.parse.call(this, n, e)
